        ...
        alternativas: [
            {
                ...
                afirmacao: "Você valoriza a promoção da educação em saúde e compreende como o acesso à informação é fundamental para prevenir doenças e contribuir para uma melhor qualidade de vida."
            },
            {
                texto: "Ampliar o acesso da população aos serviços de saúde e incentivar consultas e exames preventivos.",
                afirmacao: "Você entende que garantir o acesso aos serviços de saúde e incentivar o acompanhamento preventivo são essenciais para promover o bem-estar e cuidar da saúde da população."
            }
        ]
    },
    {
        ...
        alternativas: [
            {
                ...
                afirmacao: "Você demonstra cuidado e responsabilidade com a sua saúde, contribuindo também para o bem-estar e a segurança de toda a comunidade."
            },
            {
                ...
                afirmacao: "Você entende que promover a saúde significa cuidar do corpo e das emoções, além de adotar hábitos e atitudes que contribuam para uma rotina mais saudável."
            }
        ]
    },
    {
        ...
        alternativas: [
            {
                ...
                afirmacao: "Você entende que buscar ajuda de profissionais e contar com uma rede de apoio são atitudes importantes para preservar e fortalecer a saúde mental."
            },
            {
                texto: "Desenvolver campanhas de conscientização para combater o preconceito e incentivar as pessoas a procurar ajuda.",
                afirmacao: "Você reconhece o valor da informação e entende que reduzir o preconceito pode incentivar as pessoas a procurar ajuda e receber os cuidados necessários para a saúde mental."
            }
        ]
    }
];
